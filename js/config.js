...
// ضع هنا رابط الشعار (اختياري). يمكن تغييره لاحقًا من localStorage أيضاً.
...
if (typeof window !== 'undefined') {
  ...
  // سيأخذ الشعار من localStorage إذا كان محفوظًا هناك، وإلا سيستخدم القيمة أعلاه
  window.COMPANY_LOGO_URL = localStorage.getItem('COMPANY_LOGO_URL') || COMPANY_LOGO_URL;
}

/*
ملاحظات مهمة:
- لتعيين الشعار مرة واحدة من الكونسول في المتصفح:
  localStorage.setItem('COMPANY_LOGO_URL','https://tam74k.github.io/global/Logo1.png');

- أو حدّث COMPANY_LOGO_URL أعلاه مباشرةً.

- بقية الصفحات ستظهر الاسم العربي/الإنجليزي والشعار تلقائيًا.
*/
